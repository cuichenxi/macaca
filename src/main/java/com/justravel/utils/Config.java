...
public class Config {
   ...
   public static final String ADR_APP = RootPath + File.separator + "app/debug_v_60001063.apk";
   // 多台设备时，如果指定某一台设备可以在这里指定udid
   public static final String ADR_UDID = "LE67A06300007776";
